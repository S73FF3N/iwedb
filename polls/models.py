...
class WEC_Typ(models.Model):
    ...
    output_power = models.IntegerField(default=0, blank=True, null=True)
    rotor_diameter = models.IntegerField(default=0, blank=True, null=True)
    ...
    tot_weight_t = models.IntegerField(default=400, blank=True, null=True)
    tower_weight_t = models.IntegerField(default=250, blank=True, null=True)
    hub_weight_t = models.IntegerField(default=100, blank=True, null=True)
    rotor_weight_t = models.IntegerField(default=50, blank=True, null=True)
    min_rot_speed_r_m = models.DecimalField(max_digits=5, decimal_places=2, default=11.5, blank=True, null=True)
    max_rot_speed_r_m = models.DecimalField(max_digits=5, decimal_places=2, default=20.5, blank=True, null=True)
    cut_in = models.DecimalField(max_digits=5, decimal_places=2, default=3.5, blank=True, null=True)
    nominal_speed = models.DecimalField(max_digits=5, decimal_places=2, default=15.0, blank=True, null=True)
    cut_out = models.DecimalField(max_digits=5, decimal_places=2, default=25.0, blank=True, null=True)
    min_hub_height = models.IntegerField(default=60, blank=True, null=True)
    max_hub_height = models.IntegerField(default=140, blank=True, null=True)
