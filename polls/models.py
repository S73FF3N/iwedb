...
class WEC_Typ(models.Model):
    ...
    min_rot_speed_r_m = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True, verbose_name='Min. rotor speed [m/s]')
    max_rot_speed_r_m = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True, verbose_name='Max. rotor speed [m/s]')
