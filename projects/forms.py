...
class ProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        form_tag = False
        fields = ('name', 'status', 'prob', 'turbines', 'customer', 'new_customer', 'customer_contact', 'contract_type', 'run_time', 'department', 'request_date', 'start_operation', 'contract_signature', 'price', 'ebt', 'dwt', 'sales_manager')#, 'turbines__windfarm'
