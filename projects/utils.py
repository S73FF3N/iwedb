...
class PagedFilteredTableView(SingleTableView):
    ...
    def generate_csv(cls, request):
        ...
        font_styles = [font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, font_style, date_style, date_style, date_style, font_style, font_style, font_style, font_style]
